''' Лотерея powerball. Author A.Sweigart'''

import random

print(''' Powerball Lottery, by Al Sweigart

Each powerall lottry ticket cost $2. The jackpot for this game
is $1.586 
''')

while True:
    print('Enter 5 different numbers from 1 to 69, with spaces betweeen')
...
while True:
    print('Howe many times do you want to play? (Max: 100000)')
    response = input('> ')
    ...
    if not (1 <= numPlays <= 100000):
        print('You can play between 1 and 100000 Times.')
        continue
...
for i in range(numPlays):
    ...
    if (set(numbers) == set(winningNumbers)
        ...
        print()
        print('You hawe won the Powerball Ljttery! Congratulations,')
